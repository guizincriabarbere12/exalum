/*
  # Corrigir Criação de Venda ao Aprovar Orçamento
  
  ## Descrição
  Adiciona número sequencial e referência ao orçamento na venda criada automaticamente
  ao aprovar um orçamento, garantindo que apareça corretamente nas vendas do mês.
  
  ## Alterações
  1. Gera número sequencial para a venda (VEN-XXXXXX)
  2. Associa venda ao orçamento (orcamento_id)
  3. Calcula corretamente o subtotal dos itens da venda
  
  ## Impacto
  - Vendas criadas ao aprovar orçamentos aparecem no dashboard
